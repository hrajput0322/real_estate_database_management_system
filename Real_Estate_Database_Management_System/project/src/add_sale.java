...
public class add_sale extends JFrame implements ActionListener {
  int agent_id;
  ...
  add_sale(int id) {
    ...
    ImageIcon icon = new ImageIcon(
      "C:\\Users\\hrajp\\OneDrive\\Desktop\\Real_Estate_Database_Management_System\\project\\src\\images\\sell_icon.png"
    );
    ...
    if (e.getSource()==b1){
      ...
      if (tf11.getText().equals("") || tf12.getText().equals("") || tf13.getText().equals("") || tf14.getText().equals("")){
        ...
        if (flag1==0 || flag2==0 || flag3==0 || flag4==0){
          ...
          new property_details_sale(seller_id,agent_id,seller_name,phone_number,email);
        }
      }
    }
  }
