...
public class buy_property_3 extends JFrame implements ActionListener {
...
//   JTextField tf18 = new JTextField("6");
  ...
  buy_property_3(int agent_id, int property_id) {
    a_id = agent_id;
    p_id = property_id;
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    //   String lease_period = tf18.getText();
      ...
      if (buyer_id.equals("") || name.equals("") || phone_number.equals("") || email.equals("") || transaction_id.equals("") || transaction_amount.equals("") || transaction_date.equals("")){
        ...
        if (flag1==0 || flag2==0 || flag3==0 || flag4==0 || flag5==0 || flag6==0 || flag7==0){
          ...
          try {
            ...
            PreparedStatement q1 = conn.prepareStatement("select seller_id from seller natural join property_to_sell where property_id=?");
            q1.setInt(1, p_id);
            ...
            PreparedStatement q2 = conn.prepareStatement("select selling_commission from agent where agent_id=?");
            q2.setInt(1, a_id);
            ResultSet rs2 = q2.executeQuery();
            if (rs2.next()){
                comm = Float.parseFloat(rs2.getString("selling_commission"));
            }

            System.out.println(comm);

            Float total_comm = ((Integer.parseInt(transaction_amount) * comm/100));
            ...
            PreparedStatement psmt1 = conn.prepareStatement("insert into transactions values (?,?,?,?,?,?,?,?,?,null)");
            ...
            psmt1.setString(8,"sale");
            psmt1.setDate(9, Date.valueOf(transaction_date));
            psmt1.execute();

            PreparedStatement psmt0 = conn.prepareStatement("update property_to_sell set p_status='inactive' where property_id=?");
            psmt0.setInt(1, p_id);
            psmt0.executeUpdate(); 
