...
public class property_details_rent extends JFrame implements ActionListener {
  ...
  property_details_rent(String seller_id1, int agent_id1, String seller_name1, String phone_number1, String email1) {
    ...
    b1.setText("List Property to rent");
    b1.setOpaque(false);
      ...
      if (property_id.equals("") || address.equals("") || area.equals("") || bhk.equals("") || listing_price.equals("") || listing_date.equals("") || built_date.equals("") || status.equals("")){
        ...
        if (flag1==0 || flag2==0 || flag3==0 || flag4==0 || flag5==0 || flag6==0 || flag7==0 || flag8==0){
          ...
          try {
            ...
            PreparedStatement psmt2 = conn.prepareStatement("insert into property_to_rent values (?,?,?,?,?,?,?,?,?,?)");
